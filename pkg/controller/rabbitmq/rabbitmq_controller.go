...
import (
	...
	messagingv1alpha1 "github.com/arghya88/rabbitmq-operator/pkg/apis/messaging/v1alpha1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &messagingv1alpha1.Rabbitmq{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &messagingv1alpha1.Rabbitmq{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileRabbitmq) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &messagingv1alpha1.Rabbitmq{}
...
func newPodForCR(cr *messagingv1alpha1.Rabbitmq) *corev1.Pod {
